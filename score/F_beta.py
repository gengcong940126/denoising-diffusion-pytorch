...
class precision_recall(object):
    ...
    def compute_fid_pr(self, dataloader, gen, num_generate, num_runs, num_clusters,
...
def calculate_f_beta_score(dataloader, gen, num_generate, num_runs, num_clusters, beta,splits,fid_cache):
    ...
    is_scores,fid_score,precision, recall = PR.compute_fid_pr(dataloader, gen,
